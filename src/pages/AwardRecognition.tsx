    ...
    <div className="overflow-x-hidden" style={{ background: '#faf7ee', fontFamily: 'inherit' }}>
      ...
      <section ref={heroRef} className="relative flex items-center overflow-hidden" style={{ minHeight: '100vh', perspective: '1400px' }}>
        <motion.div style={{ y: springImg, willChange: 'transform' }} className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1600&q=80" alt="Award Recognition Hero"
            className="w-full h-full object-cover" style={{ minHeight: '120%', filter: 'brightness(0.46)' }} />
          <div className="absolute inset-0" style={{ background: 'linear-gradient(105deg,rgba(0,0,0,0.62) 0%,rgba(0,0,0,0.24) 55%,rgba(0,0,0,0.06) 100%)' }} />
          <div className="absolute bottom-0 left-0 right-0 h-28" style={{ background: 'linear-gradient(to top,rgba(196,162,58,0.12) 0%,transparent 100%)' }} />
        </motion.div>
        ...
        <motion.div style={{ y: springTxt, opacity: heroOpacity, willChange: 'transform' }}
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65, delay: 0.8 }}
            ...
            Honour your highest achievers with premium, personalised awards and gifts that make every recognition moment truly unforgettable.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 1.05 }}
            ...
            <motion.button whileHover={{ scale: 1.05, y: -2, boxShadow: '0 12px 32px rgba(196,162,58,0.45)' }}
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <motion.div variants={vStagger} initial="hidden" animate={aboutInView ? 'show' : 'hidden'}>
            ...
            <motion.div variants={vFadeUp} className="flex items-center gap-4 pt-8" style={{ borderTop: '1px solid #e8ddb0' }}>
              <div className="flex items-center justify-center rounded-full text-2xl flex-shrink-0" style={{ width: 48, height: 48, background: '#f5edcc' }}>🏆</div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <motion.div variants={vSlideLeft} initial="hidden" animate={custInView ? 'show' : 'hidden'}>
            ...
            <h2 className="text-5xl font-serif text-white leading-tight mb-6">
              Awards as Unique<br /><span style={{ color: '#e8c96a', fontStyle: 'italic', fontWeight: 400 }}>as Their Achievements</span>
            </h2>
      ...
      <section ref={ctaRef} className="py-32 px-8 text-center" style={{ background: '#f0e9cc' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={ctaInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 16 }}
            ...
            <motion.button whileHover={{ scale: 1.06, y: -3, boxShadow: '0 18px 40px rgba(196,162,58,0.35)' }}
